        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="${contentPath}/MemberMsg"><i class="fa fa-columns"></i> <span class="nav-label">会员信息</span></a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${contentPath}/shopMsg">店铺管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_flot.html">店长管理</a>
                            </li>
                        </ul>
                    </li>

                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">财务管理 </span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="mailbox.html">财务概览</a>
                            </li>
                            <li><a class="J_menuItem" href="mail_detail.html">收款明细</a>
                            </li>
                            <li><a class="J_menuItem" href="mail_compose.html">销售报表</a>
                            </li>
                            <li><a class="J_menuItem" href="${contentPath}/orderMsg">订单查询</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="form_basic.html">订单详情</a>
                            </li>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="index_v1.html">营业速报</a>
                    </div>
                </nav>
